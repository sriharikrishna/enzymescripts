...
while [ $STATUS -ne 0 ]; do
  ...
  mpirun -n 1 taskset -c 1-1 numactl -i all ~/OpenMPMPICPP/ser-mpi-forward.exe -s 64 -i 100 > ser-mpi-forward_1_100_64_1.txt & 
  mpirun -n 1 taskset -c 2-2 numactl -i all ~/OpenMPMPICPP/ser-mpi-forward.exe -s 64 -i 100 > ser-mpi-forward_1_100_64_2.txt & 
  mpirun -n 1 taskset -c 3-3 numactl -i all ~/OpenMPMPICPP/ser-mpi-forward.exe -s 64 -i 100 > ser-mpi-forward_1_100_64_3.txt & 
  mpirun -n 1 taskset -c 4-4 numactl -i all ~/OpenMPMPICPP/ser-mpi-forward.exe -s 64 -i 100 > ser-mpi-forward_1_100_64_4.txt & 
