...
while [ $STATUS -ne 0 ]; do
  ...
  mpirun -n 1 taskset -c 1-1 numactl -i all ~/OpenMPMPICPP/ser-mpi-gradient.exe -s 8 -i 100 > ser-mpi-gradient_1_100_8_1.txt & 
  mpirun -n 1 taskset -c 2-2 numactl -i all ~/OpenMPMPICPP/ser-mpi-gradient.exe -s 8 -i 100 > ser-mpi-gradient_1_100_8_2.txt & 
  mpirun -n 1 taskset -c 3-3 numactl -i all ~/OpenMPMPICPP/ser-mpi-gradient.exe -s 8 -i 100 > ser-mpi-gradient_1_100_8_3.txt & 
  mpirun -n 1 taskset -c 4-4 numactl -i all ~/OpenMPMPICPP/ser-mpi-gradient.exe -s 8 -i 100 > ser-mpi-gradient_1_100_8_4.txt & 
mywait ser 
...
mywait ser 
  ...
  mpirun -n 27 taskset -c 48-74 numactl -i all ~/OpenMPMPICPP/ser-mpi-gradient.exe -s 128 -i 100 > ser-mpi-gradient_27_100_128_1.txt & 
mywait ser 
  mpirun -n 27 taskset -c 0-26 numactl -i all ~/OpenMPMPICPP/ser-mpi-gradient.exe -s 128 -i 100 > ser-mpi-gradient_27_100_128_2.txt & 
  mpirun -n 27 taskset -c 48-74 numactl -i all ~/OpenMPMPICPP/ser-mpi-gradient.exe -s 128 -i 100 > ser-mpi-gradient_27_100_128_3.txt & 
mywait ser 
